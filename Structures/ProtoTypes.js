...
module.exports = class ProtoTypes {
  static start() {
    ...
    Message.prototype.inlineReply = async function inlineReply(content, options) {
    ...
    //INLINE REPLY NO MENTION
    Message.prototype.inlineReplyNoMention = async function inlineReplyNoMention(content, options) {
